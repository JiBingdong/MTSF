...
class SalObjDataset(Dataset):
	def __init__(self, img_name_list):
		...
		self.label_path = '/media/ailvin/F/DREYE_train/saliency_new/'
	...
	def __getitem__(self, idx):
		...
		vid_index = int(image_name[41:43])   #for /media/ailvin/F/DREYE_train/frame_garmin/01frame_000001.jpg
		frame_index = image_name[49:55]

		buffer = np.empty((16, 256, 256, 3), np.dtype('float32'))

		for i in range(16):
			image_i_name = self.image_name_list[idx - i]
			vid_index_i = int(image_i_name[41:43])
