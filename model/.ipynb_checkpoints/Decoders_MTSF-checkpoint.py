...
class DWCONV(nn.Module):
    ...
    def forward(self,x):
        ...
        xout = self.relu_s2(self.bn_s2(self.conv_s2(xout)))
...
class bolck_ACmix(nn.Module):
    def __init__(self, in_planes, out_planes):
        ...
        self.conv1 = Conv2d_1(in_planes, in_planes//2)
        self.conv2 = ACmix(in_planes//2, in_planes//2)
        self.conv3 = DWCONV(in_planes//2, out_planes)
...
class bolck_DWCONV(nn.Module):
    def __init__(self, in_planes, out_planes):
        ...
        self.conv1 = DWCONV(in_planes, out_planes)
        self.conv2 = DWCONV(out_planes, out_planes)
...
class Decoder4(nn.Module):
    def __init__(self, in_channel=512, out_channel=[512, 256, 128, 64]):
        ...
        self.deconvlayer4_5 = bolck_ACmix(in_channel, 512)
        self.upsample4_5=Upsample(scale_factor=2, mode='bilinear')
        self.deconvlayer4_4 = bolck_ACmix(out_channel[0], 256)
        self.upsample4_4=Upsample(scale_factor=2, mode='bilinear')
        self.deconvlayer4_3 = bolck_ACmix(out_channel[1], 128)  #56*56
        self.upsample4_3=Upsample(scale_factor=2, mode='bilinear')
        self.deconvlayer4_2 = bolck_DWCONV(out_channel[2], 64)
...
class Decoder3(nn.Module):
    def __init__(self, in_channel=256, out_channel=[256,128, 64], out_sigmoid=False):
        ...
        self.deconvlayer3_3 = bolck_ACmix(out_channel[0], out_channel[1])  #56*56
        self.upsample3_3=Upsample(scale_factor=2, mode='bilinear')
        self.deconvlayer3_2 = bolck_DWCONV(out_channel[1], out_channel[2])
        self.upsample3_2=Upsample(scale_factor=2, mode='bilinear')
        self.deconvlayer3_1 = bolck_DWCONV(out_channel[2], 3)
...
class Decoder2(nn.Module):
    def __init__(self, in_channel=128, out_channel=[128,64], out_sigmoid=False):
        ...
        self.deconvlayer2_3 = bolck_ACmix(in_planes=in_channel, out_planes=128) #56*56
        self.upsample2_3=Upsample(scale_factor=2, mode='bilinear')
        self.deconvlayer2_2 = bolck_DWCONV(128, 64)
