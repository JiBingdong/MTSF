...
class Decoder4(nn.Module):
    def __init__(self, in_channel=512, out_channel=[256, 128, 64]):
...
class Decoder3(nn.Module):
    def __init__(self, in_channel=256, out_channel=[128,64], out_sigmoid=False):
...
class Decoder2(nn.Module):
    def __init__(self, in_channel=128, out_channel=64, out_sigmoid=False):
